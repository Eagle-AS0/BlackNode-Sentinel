...
const Applications = () => {
  ...
  const [form, setForm] = useState({ name: '', description: '', url: '', language: '', framework: '', environment: 'development' });
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      setShowForm(false);
      setForm({ name: '', description: '', url: '', language: '', framework: '', environment: 'development' });
      fetchApps();
    } catch (err) {
            ...
            <form onSubmit={handleCreate} className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" value={form.url} onChange={e => setForm({...form, url: e.target.value})}
                  className="w-full px-4 py-2 rounded bg-gray-700 text-white border border-gray-600 focus:border-blue-500 focus:outline-none" placeholder="https://example.com" />
              </div>
              ...
              <div>
                ...
                <input type="text" value={form.language} onChange={e => setForm({...form, language: e.target.value})}
                  className="w-full px-4 py-2 rounded bg-gray-700 text-white border border-gray-600 focus:border-blue-500 focus:outline-none" placeholder="javascript" />
              </div>
              <div>
                ...
                <input type="text" value={form.framework} onChange={e => setForm({...form, framework: e.target.value})}
                  className="w-full px-4 py-2 rounded bg-gray-700 text-white border border-gray-600 focus:border-blue-500 focus:outline-none" placeholder="react" />
              </div>
              <div>
